...
# TODO: Check that this is still accurate to the test
...
for line in csv_data:
	...
	# TODO: Download this folder and place it with the directory with all this code
...
# Reproduce this survey file for the new study
...
for line in csv_file:
	...
	csv_outfile = open(str(user_index)+"_gaze_fixations.csv","wb")
	csv_out = csv.writer(csv_outfile, delimiter=",")
	csv_out.writerows([[str(fix_data[0]/1000.0),str(fix_data[1]/1000.0),str(fix_data[2]/1000.0), str(fix_data[3]),str(fix_data[4])] for fix_data in efix])
	csv_outfile.close()

	csv_outfile = open(str(user_index)+"_gaze_saccades.csv","wb")
	csv_out = csv.writer(csv_outfile, delimiter=",")
	csv_out.writerows([[str(fix_data[0]/1000.00),str(fix_data[1]/1000.0),str(fix_data[2]/1000.0), str(fix_data[3]),str(fix_data[4]),str(fix_data[5]),str(fix_data[6])] for fix_data in fsacc])
	csv_outfile.close()
